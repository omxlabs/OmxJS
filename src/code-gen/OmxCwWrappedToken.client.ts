...
import { Uint128, InstantiateMsg, MinterResponse, ExecuteMsg, Binary, Expiration, Timestamp, Uint64, Logo, EmbeddedLogo, QueryMsg, AllAccountsResponse, AllAllowancesResponse, AllowanceInfo, AllSpenderAllowancesResponse, SpenderAllowanceInfo, AllowanceResponse, BalanceResponse, String, DownloadLogoResponse, LogoInfo, Addr, MarketingInfoResponse, TokenInfoResponse } from "./OmxCwWrappedToken.types";
export interface OmxCwWrappedTokenReadOnlyInterface {
...
export class OmxCwWrappedTokenQueryClient implements OmxCwWrappedTokenReadOnlyInterface {
...
export interface OmxCwWrappedTokenInterface extends OmxCwWrappedTokenReadOnlyInterface {
  contractAddress: string;
  sender: string;
  transfer: ({
    amount,
...
export class OmxCwWrappedTokenClient extends OmxCwWrappedTokenQueryClient implements OmxCwWrappedTokenInterface {
