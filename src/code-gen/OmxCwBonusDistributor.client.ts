...
import { InstantiateMsg, ExecuteMsg, Uint128, SetAdminExec, UpdateLastDistributionTimeExec, SetBonusMultiplierExec, DistributeExec, QueryMsg, AdminQuery, RewardTokenQuery, TokenPerIntervalQuery, PendingRewardsQuery, MigrateMsg, Addr } from "./OmxCwBonusDistributor.types";
export interface OmxCwBonusDistributorReadOnlyInterface {
...
export class OmxCwBonusDistributorQueryClient implements OmxCwBonusDistributorReadOnlyInterface {
...
export interface OmxCwBonusDistributorInterface extends OmxCwBonusDistributorReadOnlyInterface {
  contractAddress: string;
  sender: string;
  setAdmin: ({
    admin
...
export class OmxCwBonusDistributorClient extends OmxCwBonusDistributorQueryClient implements OmxCwBonusDistributorInterface {
  ...
  constructor(client: SigningCosmWasmClient, sender: string, contractAddress: string) {
    ...
    this.setBonusMultiplier = this.setBonusMultiplier.bind(this);
